...
struct CustomMsg_ {
  ...
  typedef std::vector<
      ::livox_ros_driver2::CustomPoint_<ContainerAllocator>,
      typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<
          ::livox_ros_driver2::CustomPoint_<ContainerAllocator>>>
      _points_type;
  _points_type points;

  typedef boost::shared_ptr<::livox_ros_driver2::CustomMsg_<ContainerAllocator>>
      Ptr;
  typedef boost::shared_ptr<
      ::livox_ros_driver2::CustomMsg_<ContainerAllocator> const>
      ConstPtr;
...
typedef boost::shared_ptr<::livox_ros_driver2::CustomMsg const>
    CustomMsgConstPtr;
...
std::ostream& operator<<(
    std::ostream& s,
    const ::livox_ros_driver2::CustomMsg_<ContainerAllocator>& v) {
  ros::message_operations::Printer<
      ::livox_ros_driver2::CustomMsg_<ContainerAllocator>>::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(
    const ::livox_ros_driver2::CustomMsg_<ContainerAllocator1>& lhs,
    const ::livox_ros_driver2::CustomMsg_<ContainerAllocator2>& rhs) {
...
struct MD5Sum<::livox_ros_driver2::CustomMsg_<ContainerAllocator>> {
  ...
  static const char* value(
      const ::livox_ros_driver2::CustomMsg_<ContainerAllocator>&) {
    return value();
  }
...
struct DataType<::livox_ros_driver2::CustomMsg_<ContainerAllocator>> {
  static const char* value() { return "livox_ros_driver2/CustomMsg"; }
...
template <class ContainerAllocator>
struct Serializer<::livox_ros_driver2::CustomMsg_<ContainerAllocator>> {
...
struct Printer<::livox_ros_driver2::CustomMsg_<ContainerAllocator>> {
  ...
  static void stream(
      ...
      const ::livox_ros_driver2::CustomMsg_<ContainerAllocator>& v) {
    if (false || !indent.empty()) s << std::endl;
    s << indent << "header: ";
    Printer<::std_msgs::Header_<ContainerAllocator>>::stream(s, indent + "  ",
                                                             v.header);
    if (true || !indent.empty()) s << std::endl;
    s << indent << "timebase: ";
    ...
    if (true || !indent.empty()) s << std::endl;
    s << indent << "rsvd: ";
    if (v.rsvd.empty() || true) s << "[";
    for (size_t i = 0; i < v.rsvd.size(); ++i) {
      if (true && i > 0)
        s << ", ";
      else if (!true)
        s << std::endl << indent << "  -";
      Printer<uint8_t>::stream(s, true ? std::string() : indent + "    ",
                               v.rsvd[i]);
    }
    if (v.rsvd.empty() || true) s << "]";
    if (true || !indent.empty()) s << std::endl;
    s << indent << "points: ";
    if (v.points.empty() || false) s << "[";
    for (size_t i = 0; i < v.points.size(); ++i) {
      if (false && i > 0)
        s << ", ";
      else if (!false)
        s << std::endl << indent << "  -";
      Printer<::livox_ros_driver2::CustomPoint_<ContainerAllocator>>::stream(
          s, false ? std::string() : indent + "    ", v.points[i]);
    }
    if (v.points.empty() || false) s << "]";
  }
};
