...
struct CustomPoint_ {
  ...
  typedef boost::shared_ptr<
      ...
      Ptr;
  typedef boost::shared_ptr<
      ::livox_ros_driver2::CustomPoint_<ContainerAllocator> const>
      ConstPtr;
...
typedef boost::shared_ptr< ::livox_ros_driver2::CustomPoint const>
    CustomPointConstPtr;
...
std::ostream& operator<<(
    std::ostream& s,
    const ::livox_ros_driver2::CustomPoint_<ContainerAllocator>& v) {
  ros::message_operations::Printer<
      ::livox_ros_driver2::CustomPoint_<ContainerAllocator> >::stream(s, "", v);
  return s;
}

template <typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(
    const ::livox_ros_driver2::CustomPoint_<ContainerAllocator1>& lhs,
    const ::livox_ros_driver2::CustomPoint_<ContainerAllocator2>& rhs) {
  return lhs.offset_time == rhs.offset_time && lhs.x == rhs.x &&
         lhs.y == rhs.y && lhs.z == rhs.z &&
         lhs.reflectivity == rhs.reflectivity && lhs.tag == rhs.tag &&
         lhs.line == rhs.line;
}
...
struct MD5Sum< ::livox_ros_driver2::CustomPoint_<ContainerAllocator> > {
  ...
  static const char* value(
      const ::livox_ros_driver2::CustomPoint_<ContainerAllocator>&) {
    return value();
  }
...
struct DataType< ::livox_ros_driver2::CustomPoint_<ContainerAllocator> > {
  static const char* value() { return "livox_ros_driver2/CustomPoint"; }
...
template <class ContainerAllocator>
struct Serializer< ::livox_ros_driver2::CustomPoint_<ContainerAllocator> > {
